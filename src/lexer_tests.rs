...
fn c(line: u32, c: char) -> Option<(char, u32)> {
    Some((c, line))
}
...
fn chars_and_location() {
    ...
    assert_eq!(it.next(), c(1, 'a'));
    assert_eq!(it.next(), c(1, 'b'));
    assert_eq!(it.next(), c(1, 'c'));
    ...
    assert_eq!(it.next(), c(1, '\n'));
    assert_eq!(it.next(), c(2, '\n'));
    assert_eq!(it.next(), c(3, '\n'));
    assert_eq!(it.next(), c(4, '\n'));
    assert_eq!(it.next(), None);
    ...
    assert_eq!(it.next(), c(1, 'a'));
    assert_eq!(it.next(), c(1, '→'));
    assert_eq!(it.next(), c(1, 'ü'));
    assert_eq!(it.next(), c(1, 's'));
    assert_eq!(it.next(), c(1, '🦀'));
    assert_eq!(it.next(), None);
}
...
fn replace_comments() {
    ...
    assert_eq!(it.next(), c(1, 'a'));
    assert_eq!(it.next(), c(1, COMMENT_SENTINEL_VALUE));
    assert_eq!(it.next(), c(1, '\n'));
    assert_eq!(it.next(), c(2, 'b'));
    assert_eq!(it.next(), None);
